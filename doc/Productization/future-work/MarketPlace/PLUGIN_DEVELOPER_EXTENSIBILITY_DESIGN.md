...
- this document remains useful as ecosystem and product-direction framing
- it should not be treated as the final implementation baseline when it conflicts with stricter versioning, install, auth, or release-governance rules

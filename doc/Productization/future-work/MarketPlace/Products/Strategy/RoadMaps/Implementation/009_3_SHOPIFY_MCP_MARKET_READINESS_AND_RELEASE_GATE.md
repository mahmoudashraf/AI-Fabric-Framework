...
- The next required live proof is a Platform deploy, Bridge deploy, runtime deploy, fresh staging apply of `dep-8c3e7259`, followed by `full-platform-release-readiness` and `release-gate=READY`.

...
Status: strategy index and source-of-truth map (2026-04-22)
...
2. [SHOPIFY_COMPANION_BUILDER_MODE_SHIPPING_ROADMAP.md](SHOPIFY_COMPANION_BUILDER_MODE_SHIPPING_ROADMAP.md)
3. [SHOPIFY_PRODUCTS_SHIPPING_ROADMAP.md](SHOPIFY_PRODUCTS_SHIPPING_ROADMAP.md)
...
2. [SHOPIFY_COMPANION_BUILDER_MODE_SHIPPING_ROADMAP.md](SHOPIFY_COMPANION_BUILDER_MODE_SHIPPING_ROADMAP.md)
3. [SHOPIFY_PRODUCTS_SHIPPING_ROADMAP.md](SHOPIFY_PRODUCTS_SHIPPING_ROADMAP.md)
4. [LOOM_COMPANION_EMBEDDED_INTELLIGENCE_STRATEGY.md](LOOM_COMPANION_EMBEDDED_INTELLIGENCE_STRATEGY.md)
5. [LOOM_COMPANION_PRICING_AND_TIER_STRATEGY.md](LOOM_COMPANION_PRICING_AND_TIER_STRATEGY.md)
6. [SHOPIFY_AI_ENABLEMENT_EXECUTION_ROADMAP.md](SHOPIFY_AI_ENABLEMENT_EXECUTION_ROADMAP.md)
7. [Observability and Reliability Foundation Plan](../../../../../../doc/Operations/observability/OBSERVABILITY_AND_RELIABILITY_FOUNDATION_PLAN.md)
...
- [SHOPIFY_PRODUCTS_SHIPPING_ROADMAP.md](SHOPIFY_PRODUCTS_SHIPPING_ROADMAP.md)
  ...
  - Still valid for `Companion -> Companion Pro -> Loom AI Platform for Shopify`.
...
- The storefront still ships as one theme app embed launcher, not a seven-block embedded intelligence suite.
- The bridge currently supports a bounded read action set, not the full comparison / similar / size / action-rich roadmap.
- Shopify bridge billing is still configured as one free-or-paid posture, not a real `Free / Starter / Elite` commercial entitlement system.

See the builder-mode roadmap for the detailed validated gap map:

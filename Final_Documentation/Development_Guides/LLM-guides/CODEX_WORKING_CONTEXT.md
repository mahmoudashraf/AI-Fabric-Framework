...
- Staging rollout/live verification is pending commit/push and Coolify redeploy. Do not mark `010_ADMIN_TO_PARTNER_TRANSITION_READY` complete until the deployed Partner Portal operations route and Shopify embedded admin duplication guard are verified live.

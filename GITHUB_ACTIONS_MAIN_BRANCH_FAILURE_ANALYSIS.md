...
2. Maven will find the artifacts in the local repository after the first `mvn install` phase
3. The dependency graph will resolve correctly without trying to fetch non-existent artifacts from Maven Central

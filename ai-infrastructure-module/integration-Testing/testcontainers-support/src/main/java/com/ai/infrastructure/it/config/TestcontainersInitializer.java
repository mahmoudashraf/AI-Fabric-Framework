...
public class TestcontainersInitializer
    ...
    // Align with the official Qdrant Java client (gRPC) to avoid API/proto mismatches during tests.
    private static final String DEFAULT_IMAGE_QDRANT = "qdrant/qdrant:v1.16.1";

...
class OrchestratorAccessPolicyRealApiIntegrationTest {
    ...
    static Stream<Arguments> entityTypeQueryProvider() {
        return Stream.of(
            ...
            Arguments.of(
                "find documents created in the last 3 months",
                new String[]{"document"},
                "document"
            ),
            Arguments.of(
                "find accounts with risk score over 0.8",
                new String[]{"account"},
                "account"
            ),
            Arguments.of(
                "find transactions sent to high-risk region",
                new String[]{"transaction", "account"},
                "transaction"
            )
        );
    }

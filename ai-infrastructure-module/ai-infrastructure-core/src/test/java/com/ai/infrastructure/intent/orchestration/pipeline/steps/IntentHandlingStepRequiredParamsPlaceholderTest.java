...
class IntentHandlingStepRequiredParamsPlaceholderTest {
    ...
    @Test
    void shouldTreatMetadataDescriptionCopiedIntoParamsAsMissing() throws Exception {
        ActionHandler handler = new ActionHandler() {
            ...
            public ActionResult executeAction(Map<String, Object> params, String userId) {
                throw new IllegalStateException("Should not execute when required params are missing");
            }

            @Override
            public ActionResult handleError(Exception e, String userId) {
                return ActionResult.builder().success(false).message("error").build();
            }
        };

        ActionHandlerRegistry registry = new ActionHandlerRegistry(List.of(handler));
        Method init = ActionHandlerRegistry.class.getDeclaredMethod("initialize");
    ...
    @Test
    void shouldTreatInstructionLikeValueAsMissing() throws Exception {
        ActionHandler handler = new ActionHandler() {
            @Override
            public AIActionMetaData getActionMetadata() {
                return AIActionMetaData.builder()

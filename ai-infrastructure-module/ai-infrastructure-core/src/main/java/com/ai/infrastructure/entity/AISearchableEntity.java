...
@Table(
    ...
    indexes = {
        @Index(
            name = "idx_ai_searchable_vector_id",
            columnList = "vector_id"
        ),
        @Index(
            name = "idx_ai_searchable_vector_updated",
            columnList = "vector_updated_at"
        ),
        @Index(
            name = "idx_ai_searchable_entity_type",
            columnList = "entity_type"
        ),
        @Index(
            name = "idx_ai_searchable_vector_null",

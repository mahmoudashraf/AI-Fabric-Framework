...
public class RestEmbeddingProvider implements EmbeddingProvider {
    ...
    @Value("${ai.providers.rest-base-url:http://localhost:8000}")
    private String baseUrl;
    
    @Value("${ai.providers.rest-endpoint:/embed}")
    private String endpoint;
    
    @Value("${ai.providers.rest-batch-endpoint:/embed/batch}")
    private String batchEndpoint;
    
    @Value("${ai.providers.rest-timeout:30000}")
    private int timeout;
    
    @Value("${ai.providers.rest-model:all-MiniLM-L6-v2}")
    ...
    public void initialize() {
        try {
            ...
            // Create REST template with timeout

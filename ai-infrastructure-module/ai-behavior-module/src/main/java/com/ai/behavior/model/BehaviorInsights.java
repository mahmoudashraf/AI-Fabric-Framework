...
/**
 * Pre-computed insight snapshot for a user.
 */
@Entity
@Table(
    ...
    indexes = {
        ...
        @Index(name = "idx_behavior_insights_valid", columnList = "valid_until")
    }
)
@Data
@Builder
...
public class BehaviorInsights {
    ...
    public boolean isValid(LocalDateTime reference) {
        return validUntil != null && validUntil.isAfter(reference);
    }

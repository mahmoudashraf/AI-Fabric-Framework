...
- `changes/architecture/OPTIMIZATION_PROFILES_AND_DETERMINISTIC_RAG_INTEGRATION_PLAN.md` (profiles + deterministic integration)
...
Deliver `changes/architecture/MODE_DRIVEN_ORCHESTRATION_POLICY_PLAN.md`:

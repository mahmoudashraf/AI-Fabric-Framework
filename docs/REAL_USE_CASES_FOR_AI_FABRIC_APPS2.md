...
1. [Overview](#overview)
2. [Recommended Starter Apps (6 Focused Examples)](#recommended-starter-apps-6-focused-examples)
3. [Use Case Categories](#use-case-categories)
4. [E-Commerce & Retail](#e-commerce--retail)
4. [Healthcare & Life Sciences](#healthcare--life-sciences)
5. [Financial Services](#financial-services)
6. [Education & Learning](#education--learning)
7. [Legal & Compliance](#legal--compliance)
8. [HR & Talent Management](#hr--talent-management)
9. [Content & Media](#content--media)
10. [Customer Success & Support](#customer-success--support)
11. [Research & Analytics](#research--analytics)
...
- **59 REST Endpoints** - Ready-to-use API layer (via `ai-fabric-web` module)
...
- **ai-fabric-web** - 59 REST API endpoints
...
## Recommended Starter Apps (6 Focused Examples)

These **6 focused example applications** are recommended as starting points. They demonstrate core framework capabilities with practical, implementable solutions. Each includes complete data models, REST endpoints, and implementation guidance.
...
**Total: 22 extended use cases** (plus 6 recommended starter apps above)
...
1. **REST API Layer** - Using AI Fabric Web module (59 endpoints available via `ai-fabric-web`)
...
✅ **Web Module** - 59 REST endpoints via `ai-fabric-web`  
...
1. **Choose a starter app** from the 6 recommended examples

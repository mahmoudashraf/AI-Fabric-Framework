...
- **Proposed conventional commits (per ticket)**:
  - `feat(ai): implement P4.1-A (Extract AI Module to Separate Repository) [P4.1-A (Extract AI Module to Separate Repository)]`
  - `feat(ai): implement P4.1-B (Configure Maven Central Publishing) [P4.1-B (Configure Maven Central Publishing)]`

(function () {
  ...
  function render(options) {
    ...
    var storefrontContext = options.storefrontContext

    root.dataset.status = 'ready'
    root.textContent = ''
    var resolvedLauncherLabel = (payload.launcherLabel || options.launcherLabel || 'Ask the store assistant').trim()

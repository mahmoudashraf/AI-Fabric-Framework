-- V128 upgraded the known first-party DATA manifests. Customer-installed and
-- historical DATA manifests can declare additional entity types, so discover
-- and migrate every legacy entity entry before strict V0_4 startup validation.
--
-- Marketplace DATA records expose their searchable body through "content".
-- The Platform injects tenantId as server-owned metadata during Data Sync.

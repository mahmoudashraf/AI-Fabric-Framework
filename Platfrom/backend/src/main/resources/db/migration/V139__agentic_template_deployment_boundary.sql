insert into platform_marketplace_plugin_versions (
    ...
    'mkv-template-agentic-specialist-team-v104',
              ...
              "document": {
                ...
                "metadata-fields": [
                  ...
                  },
                  {
                    "name": "deploymentId",
                    "data-type": "ID",
                    "description": "Server-owned deployment isolation key.",
                    "destinations": ["VECTOR_METADATA"],
                    "priority": 100,
                    "required": true,
                    "sanitize-pii": false
    ...
    'system',
    current_timestamp,
    'Agentic template preserving trusted tenant and deployment boundaries in indexed evidence; the shell uses a supported conversational mode while Agentic work remains on the behavior operation API.',
    'seeded-template-agentic-specialist-team-v104',
    current_timestamp,
    current_timestamp
);

...
public interface PlatformManagedInferenceEndpointRepository
    ...
    List<PlatformManagedInferenceEndpointEntity> findAllByServiceIdOrderByProfileRefAsc(String serviceId);

    Optional<PlatformManagedInferenceEndpointEntity> findByServiceIdAndEndpointPurposeIgnoreCase(String serviceId,

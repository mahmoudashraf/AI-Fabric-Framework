...
public interface PartnerStoreAccessRequestRepository extends JpaRepository<PartnerStoreAccessRequestEntity, String> {
    ...
    Optional<PartnerStoreAccessRequestEntity> findByIdAndShopDomainIgnoreCase(String id, String shopDomain);

    List<PartnerStoreAccessRequestEntity> findByShopDomainIgnoreCaseOrderByCreatedAtDesc(String shopDomain);

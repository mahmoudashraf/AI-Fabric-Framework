 ...
 * or browser-direct, and should treat {@code connectorBaseUrl} as withheld.
 * Customer-facing business CRUD routes such as cart or order APIs are not
 * implied by this response unless an explicit runtime-backed CRUD surface is
 * published later.</p>
 */

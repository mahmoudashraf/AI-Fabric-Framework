...
class PublicProvisioningApiIntegrationTest {
    ...
    void publicClientCanCreateInspectAndIdempotentlyApplyDeployment() throws Exception {
        ...
        mockMvc.perform(get("/api/public/deployments/{deploymentId}", deploymentId)
            ...
            .andExpect(jsonPath("$.integration.preferredConnectorReadProxyBaseUrl", nullValue()))
            ...
            .andExpect(jsonPath("$.access.preferredConnectorReadProxyBaseUrl", nullValue()))
        ...
        mockMvc.perform(get("/api/public/deployments/{deploymentId}/status", deploymentId)
            ...
            .andExpect(jsonPath("$.integration.preferredConnectorReadProxyBaseUrl", notNullValue()))
            ...
            .andExpect(jsonPath("$.access.preferredConnectorReadProxyBaseUrl", notNullValue()))

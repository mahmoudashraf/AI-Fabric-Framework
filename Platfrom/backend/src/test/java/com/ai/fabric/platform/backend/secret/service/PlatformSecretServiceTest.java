...
class PlatformSecretServiceTest {
    ...
    void resolveSecretPrefersDatabaseValueOverEnvironmentFallback() {
        ...
        PlatformSecretService service = new PlatformSecretService(repository, environment);
    ...
    void updateSecretReturnsDatabaseBackedSummary() {
        ...
        when(repository.findAll()).thenReturn(List.of());
        PlatformSecretService service = new PlatformSecretService(repository, new MockEnvironment());

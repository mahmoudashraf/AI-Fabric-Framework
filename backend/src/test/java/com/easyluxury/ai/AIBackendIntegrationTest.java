...
public class AIBackendIntegrationTest {
    ...
    public AIBackendIntegrationTest(
            ...
            ProductAIFacade productAIFacade,
            UserAIFacade userAIFacade,
            OrderAIFacade orderAIFacade,
        ...
        this.productAIFacade = productAIFacade;
        this.userAIFacade = userAIFacade;
        this.orderAIFacade = orderAIFacade;

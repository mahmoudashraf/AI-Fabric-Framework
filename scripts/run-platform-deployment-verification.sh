...
RUNTIME_PRIVATE_AUTHORIZATION="${RUNTIME_PRIVATE_AUTHORIZATION}" \
RUNTIME_PRIVATE_AUTHORIZATION_HEADER="${RUNTIME_PRIVATE_AUTHORIZATION_HEADER}" \
VECTORIZATION_COUNTERPART_DEPLOYMENT_ID="${VECTORIZATION_COUNTERPART_DEPLOYMENT_ID}" \
python3 - <<'PY'
import json
import os
...
env["API_KEY"] = os.environ["APP_ADMIN_API_KEY"]
...
if os.environ.get("RUNTIME_PRIVATE_AUTHORIZATION"):
    env["RUNTIME_PRIVATE_AUTHORIZATION"] = os.environ["RUNTIME_PRIVATE_AUTHORIZATION"]
if os.environ.get("RUNTIME_PRIVATE_AUTHORIZATION_HEADER"):
    env["RUNTIME_PRIVATE_AUTHORIZATION_HEADER"] = os.environ["RUNTIME_PRIVATE_AUTHORIZATION_HEADER"]
